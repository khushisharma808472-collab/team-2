...
import { Bell, CheckCheck, CheckCircle2, AlertTriangle, Info } from "lucide-react";
    ...
    <>
      <div className="welcome-section" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          ...
          <p>Milestone sign-off notifications, invoice disbursements, and monthly photo bulletin releases.</p>
        </div>
        <button
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((n) => {
                ...
                return (
                  ...
                  >
                    <div className={`activity-icon ${n.type === "success" ? "project" : "user"}`}>
                      <Icon size={16} />
                    </div>
                    <div style={{ flex: 1 }}>
